...
import { registerUser, googleSignIn, syncUserToMongoDB } from "../services/authService";
...
export default function RegisterPage() {
  ...
  await setDoc(doc(db, "users", cred.user.uid), {
    name: form.name, email: form.email, role: "user", createdAt: new Date()
  });
  await syncUserToMongoDB(cred.user);
  navigate("/services");
} catch (err) {
